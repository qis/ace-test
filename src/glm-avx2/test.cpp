...
#ifndef __AVX2__
#error Compiler option missing: -mavx2
#endif

#if !(GLM_ARCH & GLM_ARCH_AVX2_BIT)
#error GLM_FORCE_AVX2 not defined
#endif
...
#error GLM_FORCE_DEFAULT_ALIGNED_GENTYPES not defined
#endif

#if !defined(GLM_FORCE_ALIGNED_GENTYPES) || GLM_CONFIG_ALIGNED_GENTYPES != GLM_ENABLE
#error GLM_FORCE_ALIGNED_GENTYPES not set by GLM_FORCE_DEFAULT_ALIGNED_GENTYPES
#endif
